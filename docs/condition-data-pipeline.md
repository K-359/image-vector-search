...
[5,000枚の選定](reports/condition-selection-5000.md)は完了しました。2026-09-25に5,000枚の本生成・条件判定・学習用ペア作成を完了しました。学習は未開始です。
...
captionは含めていないため、学習・評価では画像のみを入力し、`--use-caption`を付けません。2026-09-25にQLoRA学習を開始しました。設定と進捗確認方法は[学習実行記録](reports/condition-qlora.md)を参照してください。

...
CAPTION_PROMPT = (
    "入力画像は車内または車載カメラから撮影された交通シーンです。状況説明を4文程度の日本語で出力してください。"
    "今後、自車が車両・自転車・歩行者などの対象物と接触する恐れがある場合は、その内容を具体的に説明してください。"
    "説明の際は、対象物の自車から見た位置、向き（左向き/右向き/奥向き/手前向き）も説明してください。"
    "改行や段落は必要ありません。"
)
